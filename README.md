...
- [ReliaDB EXPLAIN Analyzer](https://github.com/Mughees52/mysql-explain-analyzer) - a browser-based MySQL and MariaDB EXPLAIN visualizer with 49 detection rules, index advisor, query rewrite suggestions, and impact simulation. Supports EXPLAIN ANALYZE, FORMAT=JSON, and MariaDB ANALYZE. 100% client-side.
